...
/**
 * Created by SterlingRyan on 4/14/2017.
 */

public class AddNewNumbersDialogFragment extends DialogFragment{
     ...
     */
    public static  AddNewNumbersDialogFragment newInstance(String title, String name, String attribute, String participant) {
        AddNewNumbersDialogFragment addNewNumbersDialogFragment = new  AddNewNumbersDialogFragment();
        Bundle bundle = new Bundle();
        bundle.putString("title", title);
        bundle.putString("name", name);
        bundle.putString("attribute", attribute);
        bundle.putString("participantID", participant);
        addNewNumbersDialogFragment.setArguments(bundle);
        return addNewNumbersDialogFragment;
    }
