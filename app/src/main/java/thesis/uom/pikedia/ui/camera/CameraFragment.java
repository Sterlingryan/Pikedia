...
public class CameraFragment extends Fragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener =
            new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    ...
                    //intent.putExtra("bitmap", getBitmap());
    ...
    // Choose the smallest dimensions that is at least as large ax the texture view.
    ...
    // Starts background thread and its Handler
    ...
    private void setUpCameraOutputs(int width, int height){
        ...
        try{
            for (String cameraId: manager.getCameraIdList()){
                ...
                //Get he direction which the camera is facing
                Integer facing = characteristics.get(CameraCharacteristics.LENS_FACING);
                if (facing != null && facing == CameraCharacteristics.LENS_FACING_FRONT){
                    continue;
                }

                // Gets a map of available configurations that the device supports.
    ...
    private void createCameraPreviewSession(){
        try{
            ...
            // Configure the size of the buffer to the size of the camera preview
    ...
    // Creates permission dialogue and act accordingly
    ...
    // Run precapture sequence for capturing a still image.
